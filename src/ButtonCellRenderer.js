...
export const ButtonCellRenderer = (props) => {
    ...
    if(status === 'Declined'){
        ...
        <div>
            ...
            <Button className="action-button" hidden>https://4.bp.blogspot.com/-7kbrqnXfuLk/WqR6bZg882I/AAAAAAAAAkM/0vvnQrIZAwk9ijiTvfF8m5pWpBSJsKuFQCLcBGAs/s1600/Screen%2BShot%2B2018-03-10%2Bat%2B7.37.12%2BPM.png</Button>
        </div>
        );
    }
    if(status === 'Pending') {
